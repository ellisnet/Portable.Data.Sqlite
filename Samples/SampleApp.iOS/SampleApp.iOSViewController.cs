...
namespace SampleApp.iOS {
    public partial class SampleAppiOSViewController : UIViewController {
        static bool UserInterfaceIdiomIsPhone {
            get { return UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Phone; }
        }

        public SampleAppiOSViewController(IntPtr handle)
            : base(handle) {
        }
        ...
        public override void ViewDidLoad() {
            ...
            //Get a handle to AppDelegate and instantiate my "crypt engine"
            var myApp = (AppDelegate)UIApplication.SharedApplication.Delegate;
            ...
            UIAlertView alert = new UIAlertView {
                Title = "All Done! - Check the Output window",
                Message = "If you can see this message, then the sample Portable.Data.Sqlite code ran correctly. " +
                "Take a look at the code in the 'SampleApp.iOSViewController.cs' file, and compare it to what you are seeing in the IDE Output window. " +
                "And have a nice day..."
            };
            alert.AddButton("OK");
            alert.Show();
